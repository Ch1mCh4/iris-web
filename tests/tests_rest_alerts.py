...
class TestsRestAlerts(TestCase):
    ...
    def test_update_alert_should_return_200_when_alert_title_change(self):
        alert_title = f'title{uuid4()}'
        new_alert_title = "test_new_title"
        body = {
            'alert_title': alert_title,
            'alert_severity_id': 4,
            'alert_status_id': 3,
        ...
        response = self._subject.create('/alerts/add', body).json()
        identifier = response['data']['alert_id']
        body = {'alert_title': new_alert_title}
    ...
    def test_update_alert_should_return_200_when_alert_context_change(self):
        ...
        response = self._subject.create('/alerts/add', body).json()
        identifier = response['data']['alert_id']
        body = {'alert_context': new_alert_context}
        response = self._subject.update(f'/api/v2/alerts/{identifier}',body).json()
    ...
    def test_update_alert_should_return_200_when_alert_description_change(self):
        ...
        response = self._subject.create('/alerts/add', body).json()
        identifier = response['data']['alert_id']
        body = {'alert_description': new_alert_description}
        response = self._subject.update(f'/api/v2/alerts/{identifier}',body).json()
    ...
    def test_update_alert_should_return_404_when_the_alert_is_not_found(self):
        alert_title = f'title{uuid4()}'
        body = {
            'alert_title': alert_title,
            'alert_severity_id': 4,
